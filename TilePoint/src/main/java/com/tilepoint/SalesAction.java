...
public class SalesAction extends ActionSupport{
	...
	private CategoryHibernateDao transHibernateDao = new CategoryHibernateDao();
	...
	// Customer page action
		...
		public String deleteSales() {
			if(salesDetails.getSalesDetailsId()!= null) {
				salesHibernateDao.deleteSalesById(salesDetails);
			}
			return SUCCESS;
		}
